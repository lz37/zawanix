...
in {
  wayland.windowManager.hyprland.settings = {
    bind = [
      ...
      "SUPER,k,movefocus,u"
      "SUPER,j,movefocus,d"
      # [hyprsplit] 原生 workspace 已被 hyprsplit 替代，以下注释保留
      # "SUPER,1,workspace,1"
      # "SUPER,2,workspace,2"
      # "SUPER,3,workspace,3"
      # "SUPER,4,workspace,4"
      ...
      # plugin
      # hyprsplit: workspace switching (per-monitor)
      ...
      # hyprsplit: move window to workspace
      ...
      # hyprsplit: workspace navigation
      "SUPER CONTROL,right,split:workspace,e+1"
      "SUPER CONTROL,left,split:workspace,e-1"
      "SUPER,mouse_down,split:workspace,e+1"
      "SUPER,mouse_up,split:workspace,e-1"
      # hyprsplit: swap all windows between two monitors
      "SUPER SHIFT,S,split:swapactiveworkspaces,current +1"
      # hyprsplit: reclaim orphaned windows after monitor unplug
      "SUPER SHIFT,G,split:grabroguewindows"
      # old split-monitor-workspaces binds (archived)
