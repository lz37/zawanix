...
in {
  wayland.windowManager.hyprland.settings = {
    bind = [
      ...
      "$modifier SHIFT,Q,plugin:xtd:closeunfocused"
      "$modifier CONTROL,1,plugin:xtd:throwunfocused,1"
      "$modifier CONTROL,2,plugin:xtd:throwunfocused,2"
      "$modifier CONTROL,3,plugin:xtd:throwunfocused,3"
      "$modifier CONTROL,4,plugin:xtd:throwunfocused,4"
      "$modifier CONTROL,5,plugin:xtd:throwunfocused,5"
      "$modifier CONTROL,6,plugin:xtd:throwunfocused,6"
      "$modifier CONTROL,7,plugin:xtd:throwunfocused,7"
      "$modifier CONTROL,8,plugin:xtd:throwunfocused,8"
      "$modifier CONTROL,9,plugin:xtd:throwunfocused,9"
      "$modifier CONTROL,0,plugin:xtd:throwunfocused,10"
      "$modifier CONTROL,page_up,plugin:xtd:throwunfocused,e-1"
      "$modifier CONTROL,page_down,plugin:xtd:throwunfocused,e+1"
    ];
